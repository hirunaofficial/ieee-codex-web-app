    ...
    <section id="hero" className="min-h-screen pt-24 pb-16 animated-gradient relative grid-pattern overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10 flex flex-col justify-center min-h-[80vh]">
        <div className="flex flex-col md:flex-row items-center justify-between gap-16">
          ...
          {/* Left Content */}
          <ParallaxEffect speed={0.05} className="md:w-2/3 mb-12 md:mb-0 hero-animate">
            <h1 className="text-5xl md:text-7xl font-extrabold mb-6 blue-glow-text leading-tight">
          ...
          {/* Right Content - Enlarged Logo */}
          <div className="relative flex items-center justify-center w-full md:w-1/3">
            <div className="absolute inset-0 flex items-center justify-center -z-10">
              <div className="w-[600px] h-[600px] bg-gradient-to-br from-blue-600 to-transparent rounded-full opacity-40 blur-3xl"></div>
            </div>
            
            {/* Codex Logo - Enlarged */}
            <div className="relative flex items-center justify-center group-hover:scale-110 group-hover:rotate-3 transition-transform duration-700 cursor-pointer">
              <Image 
              ...
              {/* Hover Line Effect */}
              <div className="absolute -bottom-8 left-1/2 transform -translate-x-1/2 w-0 h-1 bg-blue-400 group-hover:w-40 transition-all duration-700"></div>
            </div>
          </div>
